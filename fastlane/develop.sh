...
export ANDROID_APP_NAME="BC Beta"

# The package Id for the Android app
export ANDROID_PACKAGE_ID=com.tenfoldtech.bcbeta
...
export SUPPLY_PACKAGE_NAME=com.tenfoldtech.bcbeta
...
export IOS_APP_NAME="BC Beta"

# The Bundle Identifier for the main app
export IOS_MAIN_APP_IDENTIFIER=com.tenfoldtech.bcbeta

# The Bundle Identifier for the extension app
export IOS_EXTENSION_APP_IDENTIFIER=com.tenfoldtech.bcbeta.BCShare

# The iOS App Group identifier used to share data between the app and the extension
export IOS_APP_GROUP=group.com.tenfoldtech.bcbeta
...
export MATCH_APP_IDENTIFIER=com.tenfoldtech.bcbeta.BCShare,com.tenfoldtech.bcbeta
...
export GITHUB_PULL_REQUEST_REPO=sirius-tech/mattermost-mobile
